        ...
        <div class="container">
            ...
            <div class="row border" style="background: #5b1412">
                <p class="w-100 text-white">
                    <div class="col-md-4 text-white">Nguyễn Đình Quang|22/04/2005</div>
                    <div class="col-md-4 text-white">Nguyễn Hữu Thắng|22/04/2005</div>
                    <div class="col-md-4 text-white">Phạm Tiến Phát|10/3/2005</div>
                </p>
            </div>
        </div>
